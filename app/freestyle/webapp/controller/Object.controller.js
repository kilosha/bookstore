sap.ui.define([
	...
	return BaseController.extend("freestyle.controller.Object", {
		...
		_onObjectMatched : function (oEvent) {
			...
			// В инпуте с тайтлом книги меняла значение
			this.getModel().attachRequestCompleted((oEvent) => {
				console.log(`
				${oEvent.getSource() }
				${oEvent.getParameter("url")}
				${oEvent.getParameter("type")}
				${oEvent.getParameter("success")}
				${oEvent.getParameter("errorobject")}
				${oEvent.getParameter("async")}
				${oEvent.getParameter("info")}
				${oEvent.getParameter("infoObject")}
				`)
				
				// // Type: sap.ui.base.EventProvider   ||   MyValue : EventProvider sap.ui.model.odata.v2.ODataModel
				// oEvent.getSource() 
					
				// // Type: 	sap.ui.model.ChangeReason (The cause of the property value change)  ||  MyValue:  binding
				// oEvent.getParameter("reason") 

				// // Type: string (The path of the property)  ||  MyValue: title
				// oEvent.getParameter("path") 

				// // Type:  sap.ui.model.Context The binding context (if available))  ||  MyValue: /Books(guid'c11ae50c-bd4d-407b-b75d-3133c5c2ddd7')
				// oEvent.getParameter("context") 

				// // Type: object (The current value of the property)  ||  MyValue: NewValue
        ...
        _getFormFragment: function (sFragmentName) {
			...
			if (!pFormFragment) {
                ...
                pFormFragment = this.loadFragment({
                    name: "freestyle.view.fragments." + sFragmentName
                });
